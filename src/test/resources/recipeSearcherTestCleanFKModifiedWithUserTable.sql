...
CREATE TABLE `recipenames` (
  ...
  KEY `recipenames_userinformation_fk` (`UserID`),
  CONSTRAINT `recipenames_userinformation_fk` FOREIGN KEY (`UserID`) REFERENCES `userinformation` (`UserID`)
...
INSERT INTO `recipenames` VALUES (1,'Crepes',NULL),(2,'Honey Pepper Sauce',NULL),(3,'Meatloaf',NULL);
...
-- Dump completed on 2024-11-12 15:31:47
