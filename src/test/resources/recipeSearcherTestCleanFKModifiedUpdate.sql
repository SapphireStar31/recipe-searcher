...
INSERT INTO `recipenames` VALUES (1,'Crepes'),(2,'Honey Pepper Sauce'),(3,'Meatloaf'),(4,'Grilled Cheese');
...
CREATE TABLE `recipenames_ingredients` (
  ...
  CONSTRAINT `FK_Ingredients_RecipeName` FOREIGN KEY (`IngredientID`) REFERENCES `ingredients` (`IngredientID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_RecipeName_Ingredients` FOREIGN KEY (`RecipeNameID`) REFERENCES `recipenames` (`RecipeNameID`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-11-12 16:20:20
